...
Read and execute `/home/neosam/programming/rust/projects/shifty/shifty-dioxus/.claude/get-shit-done/workflows/discuss-phase-assumptions.md` end-to-end.

If `DISCUSS_MODE` is `"discuss"` (or unset, or any other value):
Read and execute `/home/neosam/programming/rust/projects/shifty/shifty-dioxus/.claude/get-shit-done/workflows/discuss-phase.md` end-to-end.

...
```
Task(
  prompt="Read /home/neosam/programming/rust/projects/shifty/shifty-dioxus/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/neosam/programming/rust/projects/shifty/shifty-dioxus/.claude/get-shit-done/templates/VALIDATION.md`

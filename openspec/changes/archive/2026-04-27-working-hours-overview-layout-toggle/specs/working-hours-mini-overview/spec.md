# Capability: Working Hours Mini Overview

## Purpose

Render a per-employee summary of actual vs. target working hours below the shift plan, in either a card grid or a table layout, with a user-controlled toggle that persists across sessions.

# Billing Period Delete

## Purpose
Allow HR users to delete the most recent billing period through the employees page UI, with confirmation dialog, error handling, and full i18n support.

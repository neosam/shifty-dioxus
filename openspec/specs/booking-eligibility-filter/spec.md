# Capability: Booking Eligibility Filter

## Purpose
Filter booking dropdowns to show only eligible sales persons based on shiftplan assignments, and handle forbidden booking errors gracefully.

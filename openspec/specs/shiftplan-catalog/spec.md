...
## Purpose
Provide access to the shiftplan catalog for retrieving available shiftplans, allow users to switch between shiftplans via a tab bar, and load week view data for the active shiftplan.

# shiftplan-edit-dialog Specification

## Purpose

Provide a unified modal dialog for creating and editing shiftplan properties (name, `is_planning`) in the frontend. This replaces the inline rename on double-click and the minimal create modal with a single shared dialog component, accessible only in structure mode.

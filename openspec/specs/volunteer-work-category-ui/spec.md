# volunteer-work-category-ui Specification

## Purpose

Expose the `VolunteerWork` working-hours category in the frontend: state model conversions, the add-extra-hours form, the employee view, the billing-period details page, and the corresponding i18n translations across all supported locales.

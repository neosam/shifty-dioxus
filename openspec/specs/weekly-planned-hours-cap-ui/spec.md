# weekly-planned-hours-cap-ui Specification

## Purpose

Provide UI surface area for the per-employee "cap planned hours at expected" flag, including its representation in `EmployeeWorkDetails` state, its toggle in the work-details form, and the i18n keys needed to label and explain the flag in all supported locales.

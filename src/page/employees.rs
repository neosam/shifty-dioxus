                ...
                div { class: "space-y-6",
                    ...
                    div { class: "flex justify-end space-x-4",
                        button {
                            ...
                            onclick: move |_| {
                                page_action_handler.send(EmployeesPageAction::HideCreateBillingPeriodDialog)
                            },
                            "{i18n.t(Key::Cancel)}"
                        }
                        button {
                            ...
                            onclick: move |_| {
                                page_action_handler
                                    .send(EmployeesPageAction::CreateBillingPeriod(end_date.read().clone()));
                            },
            ...
            div { class: "mb-8",
                div { class: "flex justify-between items-center mb-4",
                    ...
                    button {
                        ...
                        onclick: move |_| {
                            page_action_handler.send(EmployeesPageAction::ShowCreateBillingPeriodDialog)
                        },
                    ...
                    div { class: "grid gap-4",
                        for billing_period in billing_periods.billing_periods.iter() {
                            Link {
                                ...
                                div { class: "bg-white shadow rounded-lg p-4 border border-gray-200 hover:shadow-lg hover:border-blue-300 transition-all cursor-pointer",
